...
$app->group('/usuario/', function () {
    ...
    $this->put(
        ...
        function ($req, $res, $args) {
            ...
            $nombre_usuario_existente = Usuario::where('id', 'not like', $usuarioToken->id)->where('username', 'like', $userneme)->get();
            ...
            $email_existente = Usuario::where('id', 'not like', $usuarioToken->id)->where('email', 'like', $email)->get();
