...
class MangaUsuario extends \Illuminate\Database\Eloquent\Model
{
    ...
    public static function getStats(Int $idUsuario)
    {
        ...
        $stats['porAño'] = MangaUsuario::selectRaw('`manga`.`añoDePublicacion` AS x, COUNT(*) AS y')->where('idUsuario', $idUsuario)->join('manga', 'manga_usuario.idUsuario', '=', 'manga.id')->groupBy('manga.añoDePublicacion')->orderBy('manga.añoDePublicacion')->get();
        return $stats;
    }
}
